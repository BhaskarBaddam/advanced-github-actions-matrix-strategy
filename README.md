...
- Test the application using Python versions 3.13, 3.12, 3.11, and 3.10
- Add an additional test for Python version 3.9 running on Ubuntu
- If the platform is Windows, skip any tests for Python version 3.13
